...
var pelicula1,pelicula3,pelicula2,pelicula4,pelicula5,peliculasV=[];
...
function generarPeliculas() {
    ...
    peliculasV[Math.floor(Math.random() * 3)]= peliculas[Math.floor(poster * peliculas.length)];
    document.getElementById("imagenposter").src = "https://image.tmdb.org/t/p/w500/" + pelicula1.poster_path;
    document.getElementById("imagen2").src = "https://image.tmdb.org/t/p/w185/" + peliculasV[2].poster_path;
    document.getElementById("imagen3").src = "https://image.tmdb.org/t/p/w185/" + peliculasV[0].poster_path;
    document.getElementById("imagen4").src = "https://image.tmdb.org/t/p/w185/" + peliculasV[3].poster_path;
    document.getElementById("imagen5").src = "https://image.tmdb.org/t/p/w185/" + peliculasV[1].poster_path;
...
function establecer(blur ,brightness, invert){
    document.getElementById("imagenposter").style.filter = `blur(${blur}px) brightness(${brightness}%) invert(${invert}%)`;
}
function cambiar() {
